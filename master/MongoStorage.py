...
class MongoStorage():
    def __init__(self):
        ...
        self.db = mongo.connect(self.db_name, host=self.db_uri, alias="default", connect=False)
        logger.debug("Connected to mongodb!")

    def get_db(self):
        return self.db[self.db_name]

    def get_task_col_name(self):
        return self.task_col

    def get_slave_col_name(self):
